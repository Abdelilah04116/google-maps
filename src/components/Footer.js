        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              Boostez votre réputation en ligne avec nos services professionnels de gestion des reviews Google Maps.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📧 contact@reviews-maps-pro.com</p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © {currentYear} Reviews Maps Pro. Tous droits réservés.
            </p>
            <p className="text-gray-300 text-sm mt-2 md:mt-0">
              Fait avec ❤️ pour booster votre business
            </p>
          </div>
        </div>
      </div>
